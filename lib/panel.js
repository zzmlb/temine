...
<div id="tabChrome" style="display:none">
  <div style="padding:16px 24px">
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px">
      <p class="section-desc" style="margin:0">所有 Chrome 窗口堆叠展示，点击窗口头部展开看 tab 列表，点 tab 直接切到对应窗口。</p>
...
function focusChromeTabClick(winId,tabIdx){
  fetch('/api/chrome/focus',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({windowId:winId,tabIndex:tabIdx})}).catch(function(){});
}
